...
const config = {
    ...
    scene: [ StartScene, CreditsScene, InstructionsScene, CenaIntro, MundoNormal, MundoNormalScene_1, MundoNormalScene_2, MundoSombrio, MundoSombrio2, Boss, GameOverScene, WinScene ]
};
