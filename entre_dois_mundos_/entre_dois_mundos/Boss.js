export default class MundoNormalScene_1 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('demon', 'assets/demon_sspritesheet.png', { frameWidth: 115, frameHeight: 180 });
    }
    ...
    this.time.delayedCall(1500, () => {
        ...
        this.anims.create({ key: 'demonIdle', frames: this.anims.generateFrameNumbers('demon', { start: 0, end: 7 }), frameRate: 6, repeat: -1 });
        this.anims.create({ key: 'demonAndando', frames: this.anims.generateFrameNumbers('demon', { start: 8, end: 15 }), frameRate: 8, repeat: -1 });
        this.anims.create({ key: 'demonAtacando', frames: this.anims.generateFrameNumbers('demon', { start: 16, end: 23 }), frameRate: 10, repeat: 0 });
    ...
    // Lira já foi salva, manter texto visível ou escondê-lo
    this.salvarTexto.setVisible(false);
}
